...
let
  ...
  wrapper = {
    ...
    # nixCats: as far as I can tell it will only ever contain `set nocompatible`
    # neovimUtils.makeNeovimConfig supplies this by calling
    # vimUtils.vimrcContent { customRC = ""; };
    , manifestRc ? null
    ...
    , wrapRc ? true # <-- nixCats always sets this to true and takes care of this itself
